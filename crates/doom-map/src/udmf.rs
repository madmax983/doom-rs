...
/// ```
/// The kind here is `"vertex"`, and it contains two [`crate::udmf::UdmfField`]s.
///
/// ## Examples
/// ```
...
/// To convert this AST into usable map geometry, you must "compile" it by calling [`crate::udmf::UdmfMap::into_level_data`].
/// ## Examples
/// ```
...
impl UdmfMap {
    ...
    /// This function acts as the "compiler"—it reads the raw [`crate::udmf::UdmfMap`] AST and
