            ...
            if !visited.contains(&node) {
                ...
                let mut stack = vec![(
                    ...
                    self.graph
                        ...
                        .get(&node)
                        .expect(
                            "node must exist in adjacency list because we are iterating over keys",
                        )
                        .iter(),
                )];
                            ...
                            *children_map.entry(u).or_default() += 1;
                            ...
                            stack.push((
                                ...
                                self.graph
                                    .adjacency_list
                                    .get(&v)
                                    .expect("neighbor must exist in adjacency list because of contains_key check")
                                    .iter(),
                            ));
                            pushed_child = true;
                            break;
...
mod tests {
    ...
    fn test_chokepoints_large_linear() {
        ...
        for i in 1..10000 {
            adj.get_mut(&i)
                .expect("key must have been inserted in the previous loop")
                .insert(i - 1);
        }
