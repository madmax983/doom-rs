...
mod tests {
    ...
    fn p_use_lines_prefers_nearest_crossed_special_over_lump_order() {
        let mut gs = GameState::new("TEST");
        let reject =
            doom_map::Reject::parse_lump(&[0u8; 2], 3).expect("Expected successful result in test");
    ...
    fn make_tagged_sector_level(
        ...
        let reject =
            doom_map::Reject::parse_lump(&[0u8; 1], 2).expect("Expected successful result in test");
    ...
    fn make_donut_level(
        ...
        let reject = doom_map::Reject::parse_lump(&reject_bytes, 3)
            .expect("Expected successful result in test");
    ...
    fn make_platform_level(adj_floor: i16, plat_floor: i16, tag: u16) -> doom_map::Level {
        ...
        let reject = doom_map::Reject::parse_lump(&reject_bytes, 2)
            .expect("Expected successful result in test");
    ...
    fn save_load_roundtrip_lift_mover() {
        ...
        let loaded = load_game(&data).expect("Expected successful result in test");
    ...
    fn save_load_roundtrip_scrolling_wall() {
        ...
        let loaded = crate::savegame::load_game(&data).expect("Expected successful result in test");
