...
mod tests {
    ...
    fn raise_to_nearest_and_change_clears_damaging_special() {
        ...
        dispatch_linedef(
            ...
            0,
            47,
            classify_trigger(47).expect("trigger type must be known"),
            actor,
            0,
        );
        ...
        dispatch_linedef(
            ...
            0,
            66,
            classify_trigger(66).expect("trigger type must be known"),
            actor,
            0,
        );
        assert_eq!(
    ...
    fn crushing_ceiling_gibs_a_corpse_in_the_sector() {
        ...
        let mo = gs.mobjslab.get(body).expect("mobj must exist in GameState");
        assert_eq!(
            mo.state,
    ...
    fn crushing_ceiling_leaves_a_live_body_intact() {
        ...
        let mo = gs.mobjslab.get(live).expect("mobj must exist in GameState");
        assert_eq!(
            mo.state, before,
