...
use crate::state::{GameState, ExitRequest};
use crate::movers::{
    CeilingMover, CeilingType, ConveyorBelt, DoorMover, FloorMover, FloorType,
    LiftMover, LiftStatus, LightEffectType, LightSpecial, MoveDirection,
...
mod tests {
    ...
    fn sector_light_effect_clone_works() {
        use crate::movers::{LightEffectType, SectorLightEffect};
