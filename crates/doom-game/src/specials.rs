...
mod tests {
    ...
    fn raise_to_nearest_and_change_clears_damaging_special() {
        ...
        dispatch_linedef(
            ...
            0,
            47,
            classify_trigger(47).expect("trigger should exist for special 47"),
            actor,
            0,
        );
        ...
        dispatch_linedef(
            ...
            0,
            66,
            classify_trigger(66).expect("trigger should exist for special 66"),
            actor,
            0,
        );
        assert_eq!(
    ...
    fn change_sector_drags_rider_down_when_floor_lowers() {
        ...
        assert_eq!(
            gs.mobjslab.get(rider).expect("mobj must exist in test").z,
        ...
        assert_eq!(
            gs.mobjslab
                .get(edge_rider)
                .expect("mobj must exist in test")
                .z,
            Fixed16_16::from_int(40),
            "edge rider (bbox over the lift) must be dragged down too"
        );
        assert_eq!(
            gs.mobjslab.get(floater).expect("mobj must exist in test").z,
            Fixed16_16::from_int(100),
    ...
    fn crushing_ceiling_gibs_a_corpse_in_the_sector() {
        ...
        let mo = gs.mobjslab.get(body).expect("mobj must exist in test");
        assert_eq!(
            mo.state,
    ...
    fn crushing_ceiling_leaves_a_fitting_corpse_untouched() {
        ...
        assert_ne!(
            mo.height,
            Fixed16_16::ZERO,
            "an un-crushed corpse keeps its height"
        );
    }
    ...
    fn crushing_ceiling_leaves_a_live_body_intact() {
        ...
        let mo = gs.mobjslab.get(live).expect("mobj must exist in test");
        assert_eq!(
            mo.state, before,
