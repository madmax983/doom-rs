...
mod tests {
    ...
    #[test]
    fn highest_adjacent_floor_no_neighbors_returns_own() {
        let level = make_damage_level(0, 0);
        let own_floor = level.sectors[0].floor_height;
        let result = highest_adjacent_floor(&level, 0);
        assert_eq!(
            result, own_floor,
    ...
    #[test]
    fn lowest_adjacent_ceiling_no_neighbors_returns_own() {
        let level = make_damage_level(0, 0);
        let own_ceil = level.sectors[0].ceil_height;
        let result = lowest_adjacent_ceiling(&level, 0);
        assert_eq!(
            result, own_ceil,
