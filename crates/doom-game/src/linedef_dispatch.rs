...
///
/// ⚡ Bolt Optimization: Uses SmallVec to avoid heap allocations when dispatching triggers,
/// while still collecting the indices to satisfy the borrow checker for subsequent mutation.
