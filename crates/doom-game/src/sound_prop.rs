//! Sound Propagation and Event Dispatch.
//!
//! Handles how noise travels through the map's blockmap to wake up monsters,
//! and collects auditory events (`SoundRequest`) generated by the simulation
//! so the external app layer can play PCM sound effects.
