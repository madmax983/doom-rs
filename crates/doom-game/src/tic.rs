...
/// Advances the simulation for all map objects (mobjs) by a single tic.
///
/// This function coordinates the sequential update of all active actors in the game
/// world. It ensures that actors present at the start of the tic are updated first,
/// followed by any new entities (like fired missiles) spawned during this same tic.
