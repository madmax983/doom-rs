...
/// Ticks every actor in the world for a single frame.
///
/// This is the main entry point for processing the simulation state of all game objects,
/// taking into account their spawn generation to ensure stable ordering.
