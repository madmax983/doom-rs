...
/// Ticks all map objects (mobjs) for a single simulation tic.
///
/// This function processes every actor that existed at the start of the tic,
/// followed by the missiles spawned during this very tic, iterating in creation order.
///
/// # Examples
///
/// ```
/// use doom_game::GameState;
/// use doom_game::tic::tick_all_mobjs;
