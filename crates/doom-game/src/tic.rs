...
/// Ticks all map objects in the simulation.
///
/// This function splits the iteration by actor generation. This allows the simulation
/// to interleave sector-light updates between existing map objects and newly spawned missiles,
/// perfectly matching vanilla Doom's thinker-list ordering.
///
/// ## Examples
///
/// ```
/// use doom_game::GameState;
/// use doom_game::tick_all_mobjs;
///
