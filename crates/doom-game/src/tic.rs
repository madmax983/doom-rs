...
/// Executes a single tic of the thinker simulation for all map objects.
///
/// This processes every actor that existed at the start of the tic,
/// followed by any missiles spawned during this tic, ensuring
/// predictable evaluation order based on creation generation.
