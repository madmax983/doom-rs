...
const BFG_SOUND: u8 = Action::BfgSound as u8;
const BRAIN_AWAKE: u8 = Action::BrainAwake as u8;
const BRAIN_DIE: u8 = Action::BrainDie as u8;
const BRAIN_EXPLODE: u8 = Action::BrainExplode as u8;
const BRAIN_SCREAM: u8 = Action::BrainScream as u8;
const BRAIN_SPIT: u8 = Action::BrainSpit as u8;
const BRUIS_ATTACK: u8 = Action::BruisAttack as u8;
const BSPI_ATTACK: u8 = Action::BspiAttack as u8;
const CHASE: u8 = Action::Chase as u8;
const CHECK_RELOAD: u8 = Action::CheckReload as u8;
const CLOSE_SHOTGUN2: u8 = Action::CloseShotgun2 as u8;
const CPOS_ATTACK: u8 = Action::CposAttack as u8;
const FALL: u8 = Action::Fall as u8;
const FAT_ATTACK1: u8 = Action::FatAttack1 as u8;
const FIRE: u8 = Action::Fire as u8;
const FIRE_BFG: u8 = Action::FireBfg as u8;
const FIRE_CGUN: u8 = Action::FireCgun as u8;
const FIRE_MISSILE: u8 = Action::FireMissile as u8;
const FIRE_PISTOL: u8 = Action::FirePistol as u8;
const FIRE_PLASMA: u8 = Action::FirePlasma as u8;
const FIRE_SHOTGUN: u8 = Action::FireShotgun as u8;
const FIRE_SHOTGUN2: u8 = Action::FireShotgun2 as u8;
const GUN_FLASH: u8 = Action::GunFlash as u8;
const LIGHT0: u8 = Action::Light0 as u8;
const LIGHT1: u8 = Action::Light1 as u8;
const LIGHT2: u8 = Action::Light2 as u8;
const LOAD_SHOTGUN2: u8 = Action::LoadShotgun2 as u8;
const LOOK: u8 = Action::Look as u8;
const LOWER: u8 = Action::Lower as u8;
const NONE: u8 = Action::None as u8;
const OPEN_SHOTGUN2: u8 = Action::OpenShotgun2 as u8;
const PAIN_ATTACK: u8 = Action::PainAttack as u8;
const POS_ATTACK: u8 = Action::PosAttack as u8;
const PUNCH: u8 = Action::Punch as u8;
const RAISE: u8 = Action::Raise as u8;
const REFIRE: u8 = Action::Refire as u8;
const SARG_ATTACK: u8 = Action::SargAttack as u8;
const SAW: u8 = Action::Saw as u8;
const SCREAM: u8 = Action::Scream as u8;
const SKEL_MISSILE: u8 = Action::SkelMissile as u8;
const SKULL_ATTACK: u8 = Action::SkullAttack as u8;
const SPOS_ATTACK: u8 = Action::SposAttack as u8;
const TROO_ATTACK: u8 = Action::TrooAttack as u8;
const VILE_ATTACK: u8 = Action::VileAttack as u8;
const VILE_CHASE: u8 = Action::VileChase as u8;
const VILE_START: u8 = Action::VileStart as u8;
const VILE_TARGET: u8 = Action::VileTarget as u8;
const WEAPON_READY: u8 = Action::WeaponReady as u8;
...
mod tests {
    ...
    fn s_null_holds_forever() {
        ...
        assert_eq!(e.action, actions::Action::None as u8);
    ...
    fn poss_stnd_alternates_with_second_idle_frame() {
        ...
        assert_eq!(e.action, actions::Action::Look as u8);
        ...
        assert_eq!(e2.action, actions::Action::Look as u8);
    ...
    fn poss_run_cycles_with_chase() {
        ...
        assert_eq!(run1.action, actions::Action::Chase as u8);
        assert_eq!(run2.action, actions::Action::Chase as u8);
        assert_eq!(run3.action, actions::Action::Chase as u8);
        assert_eq!(run4.action, actions::Action::Chase as u8);
    }
    ...
    fn attack_states_return_to_run() {
        ...
        assert_eq!(atk3.action, actions::Action::None as u8);
    ...
    fn attack_atk2_fires_correct_action() {
        assert_eq!(
            ...
            actions::Action::PosAttack as u8
        );
        assert_eq!(
            STATES[ids::S_SPOS_ATK2 as usize].action,
            actions::Action::SposAttack as u8
        );
        assert_eq!(
            STATES[ids::S_TROO_ATK2 as usize].action,
            actions::Action::TrooAttack as u8
        );
        assert_eq!(
            STATES[ids::S_SARG_ATK2 as usize].action,
            actions::Action::SargAttack as u8
        );
    }
    ...
    fn weapon_ready_and_transition_states_use_psprite_actions() {
        assert_eq!(
            ...
            actions::Action::Raise as u8
        );
        assert_eq!(
            STATES[ids::S_PISTOL_DOWN as usize].action,
            actions::Action::Lower as u8
        );
        assert_eq!(
            STATES[ids::S_PISTOL_READY as usize].action,
            actions::Action::WeaponReady as u8
        );
        assert_eq!(
    ...
    fn key_weapon_attack_states_fire_psprite_actions() {
        ...
        assert_eq!(
            ...
            actions::Action::Light0 as u8
        );
        assert_eq!(
            STATES[ids::S_MISSILE2 as usize].action,
            actions::Action::FireMissile as u8
        );
        assert_eq!(
            STATES[ids::S_PLASMA1 as usize].action,
            actions::Action::FirePlasma as u8
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            actions::Action::BfgSound as u8
        );
        assert_eq!(
            STATES[ids::S_BFG2 as usize].action,
            actions::Action::FireBfg as u8
        );
        assert_eq!(
            STATES[ids::S_DSGUN4 as usize].action,
            actions::Action::CheckReload as u8
        );
        assert_eq!(
            STATES[ids::S_DSGUN5 as usize].action,
            actions::Action::OpenShotgun2 as u8
        );
        assert_eq!(
            STATES[ids::S_DSGUN6 as usize].action,
            actions::Action::LoadShotgun2 as u8
        );
        assert_eq!(
            STATES[ids::S_DSGUN7 as usize].action,
            actions::Action::CloseShotgun2 as u8
        );
        assert_eq!(
    ...
    fn plasma_and_ssg_attack_chains_match_doom_psprite_shape() {
        ...
        assert_eq!(STATES[ids::S_SGUN4 as usize].action, actions::Action::Refire as u8);
        assert_eq!(STATES[ids::S_SAW3 as usize].action, actions::Action::Refire as u8);
    }
    ...
    fn chaingunner_attack_uses_cpos_action() {
        assert_eq!(
            ...
            actions::Action::CposAttack as u8
        );
    }
    ...
    fn revenant_attack_uses_skel_missile() {
        assert_eq!(
            ...
            actions::Action::SkelMissile as u8
        );
    }
    ...
    fn mancubus_attack_uses_fat_attack() {
        assert_eq!(
            ...
            actions::Action::FatAttack1 as u8
        );
    }
    ...
    fn arachnotron_attack_uses_bspi_attack() {
        assert_eq!(
            ...
            actions::Action::BspiAttack as u8
        );
    }
    ...
    fn pain_elemental_attack_uses_pain_attack() {
        assert_eq!(
            ...
            actions::Action::PainAttack as u8
        );
    }
    ...
    fn lost_soul_attack_uses_skull_attack() {
        assert_eq!(
            ...
            actions::Action::SkullAttack as u8
        );
    }
