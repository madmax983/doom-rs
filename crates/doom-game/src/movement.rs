...
///
/// PERF: Uses `smallvec::SmallVec` to eliminate per-ray heap allocations for the `spechit`
/// array, keeping short intersection walks on the stack since crossings rarely exceed 8 lines.
#[must_use]
pub fn move_spechit(
    slab: &MobjSlab,
    handle: MobjHandle,
