...
pub fn p_try_move_commit_tracked(
    ...
    y: Fixed16_16,
    level: &Level,
    sink: &mut smallvec::SmallVec<[usize; 8]>,
) -> bool {
...
fn p_try_move_commit_inner(
    ...
    y: Fixed16_16,
    level: &Level,
    sink: Option<&mut smallvec::SmallVec<[usize; 8]>>,
) -> bool {
...
pub fn move_spechit(
    ...
    /// Optimization: Use SmallVec to avoid heap allocation for the typical case
    /// of an actor crossing < 8 lines per tic during movement loops.
    ...
    let mut seen: smallvec::SmallVec<[usize; 8]> = smallvec::SmallVec::new();
