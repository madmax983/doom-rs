...
#[must_use]
/// Returns special lines crossed by the move.
///
/// Optimized: Uses `SmallVec` to eliminate dynamic heap allocations
/// for the vast majority of movement checks (typically crossing 0-2 lines).
pub fn move_spechit(
    slab: &MobjSlab,
    handle: MobjHandle,
    new_x: Fixed16_16,
