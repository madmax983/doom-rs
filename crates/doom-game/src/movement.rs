...
///
/// **Performance optimization:** `SmallVec` is used for the `spechit` and `seen`
/// collections to eliminate excessive dynamic heap allocations during
/// hot-path collision detection. The arrays allocate inline on the stack
/// for the vast majority of movement checks.
#[must_use]
pub fn move_spechit(
    slab: &MobjSlab,
    handle: MobjHandle,
