...
pub mod span;
pub mod sprite;
/// Functions and types for clipping sprites against solid geometry in the software renderer.
pub mod sprite_clip;
...
pub use automap::{
    RendererAutomapCanvas, draw_automap, draw_automap_ex, draw_grid_on_fb, draw_line_fb,
    draw_player_arrow_on_fb, line_color, map_to_screen, render_automap,
};
