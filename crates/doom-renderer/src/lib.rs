...
pub use weapon_anim::{
    MAX_BOB, RAISE_SPEED, WEAPON_BASE_X, WEAPON_BASE_Y, WEAPON_BOTTOM, WEAPON_TOP, WeaponAnimState,
    WeaponBob, WeaponSprite, draw_weapon_animated, weapon_sprite_name,
};
