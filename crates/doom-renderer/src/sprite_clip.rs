...
impl SpriteClipHistory {
    ...
    ///
    /// If the history is full (capacity is 8), the step is silently dropped to avoid heap allocation.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// history.push(SpriteClipStep { depth: 20.0, row: 60, silhouette_height: 64.0 });
    ///
