...
//!
//! This module provides a fast, heapless `SpriteClipHistory` used to
//! track silhouette heights as sprites are rendered behind multiple visplanes.
...
impl SpriteClipHistory {
    ...
    /// Pushes a new clip step onto the history stack.
    ///
    /// If the stack is full (more than 8 steps), the operation silently drops
    /// the step to avoid heap allocation.
    ///
    /// ## Examples
    ///
    /// ```
    ...
    /// Returns the most recently pushed clip step, if any.
    ///
    /// ## Examples
    ///
    /// ```
