...
impl SpriteClipHistory {
    ...
    ///
    /// If the internal array is full, additional pushes are silently ignored
    /// (dropped) to avoid heap allocations.
    ///
    /// ## Examples
    ///
    /// ```
    ...
    /// Returns a reference to the last inserted clipping step, if any.
    ///
    /// ## Examples
    ///
    /// ```
