...
impl SpriteClipHistory {
    ...
    ///
    /// Drops extra clips if the array size limit (8) is exceeded to avoid heap allocations.
    ...
    /// Returns the last `SpriteClipStep` pushed, or `None` if the history is empty.
