...
mod tests {
    ...
    fn inactive_menu_draws_nothing() {
        ...
        let menu = GameMenu::new(doom_types::game_version::GameVersion::Doom1); // inactive by default
    ...
    fn active_menu_darkens_background() {
        ...
        let mut menu = GameMenu::new(doom_types::game_version::GameVersion::Doom1);
        menu.open();
        draw_menu(&mut fb, &menu, &font);
