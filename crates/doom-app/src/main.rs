...
fn run_verify_demo(args: &Args, wad_stack: &WadStack, source: &str) -> Result<()> {
    ...
    if is_tty {
        println!(
            "{} {} for {}",
            "🔬".cyan(),
            "Demo Verification".cyan().bold(),
            source_label.clone().yellow()
        );
    } else {
    ...
    if is_tty {
        ...
        table.add_row(vec![
            ...
            comfy_table::Cell::new(source_label.to_string()).fg(comfy_table::Color::Yellow),
        ]);
        table.add_row(vec![
        ...
        table.add_row(vec![
            comfy_table::Cell::new("⏱️  Tics (File)"),
        ...
        table.add_row(vec![
            comfy_table::Cell::new("⏱️  Tics (Played)"),
            comfy_table::Cell::new(r0.total_tics.to_string()).fg(comfy_table::Color::Cyan),
        ]);
        table.add_row(vec![
        ...
        table.add_row(vec![
            comfy_table::Cell::new("📍 Final Pos (Int)"),
            comfy_table::Cell::new(format!(
                "({}, {}, {})",
                r0.final_px_int, r0.final_py_int, r0.final_pz_int
            ))
            .fg(comfy_table::Color::Green),
        ]);
        table.add_row(vec![
            comfy_table::Cell::new("📐 Final Angle"),
            comfy_table::Cell::new(r0.final_angle.to_string()).fg(comfy_table::Color::Green),
        ]);
        table.add_row(vec![
        ...
        table.add_row(vec![
            ...
            comfy_table::Cell::new(r0.final_rndindex.to_string()).fg(comfy_table::Color::Magenta),
        ]);
        if determinism_pass {
            table.add_row(vec![
        ...
        table.add_row(vec![
            comfy_table::Cell::new("Source"),
            comfy_table::Cell::new(source_label.to_string()),
        ]);
        table.add_row(vec![
        ...
        table.add_row(vec![
            comfy_table::Cell::new("Tics (File)"),
            comfy_table::Cell::new(
                DemoPlayer::from_lmp(&demo_bytes)
                    .map_or(0, |p| p.total_tics())
                    .to_string(),
        ...
        table.add_row(vec![
            comfy_table::Cell::new("Tics (Played)"),
        ...
        table.add_row(vec![
            comfy_table::Cell::new("Final Pos (Raw)"),
            comfy_table::Cell::new(format!(
                "({}, {}, {})",
                r0.final_px_raw, r0.final_py_raw, r0.final_pz_raw
            )),
        ]);
        table.add_row(vec![
            comfy_table::Cell::new("Final Pos (Int)"),
