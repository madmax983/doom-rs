...
fn audio_cmd_thread(
    ...
    // We use a fixed-size array instead of a HashMap because tracking at most
    // 8 channels is significantly faster with a linear scan, avoiding hashing
    // overhead and dynamic allocations on this hot path.
