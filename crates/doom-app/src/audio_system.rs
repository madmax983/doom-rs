...
pub(crate) fn weapon_fire_sfx_lump(weapon: doom_game::WeaponType) -> &'static str {
...
pub(crate) fn build_sfx_lookup(wad: &WadStack) -> std::collections::HashMap<String, u16> {
...
pub(crate) fn monster_wake_lump(kind: doom_game::MobjKind) -> &'static str {
...
pub(crate) fn monster_attack_lump(kind: doom_game::MobjKind) -> &'static str {
    use doom_game::MobjKind;
    match kind {
...
pub(crate) fn monster_death_lump(kind: doom_game::MobjKind) -> &'static str {
    use doom_game::MobjKind;
    match kind {
