...
## 🔍 Gap Analysis
- **Current State:** The game hardcodes default behaviors. The settings menu is visually present but functionally a stub.
- **Standard Libs / Market:** Most terminal-based games or applications use lightweight serialization formats to manage configurations locally in a standard user directory. Implementing this is a standard and expected pattern for any modern source port or engine clone.
