...
## 🔍 Gap Analysis
- **Current State:** The Options menu has a "Controls" placeholder item. Key mappings are likely statically defined in the input system. Gamepad support is being implemented but lacks dynamic rebinding.
- **Standard Libs / Market:** Almost all PC games provide key rebinding.

## ✅ Acceptance Criteria
- Must implement a new menu page accessible from the Options menu.
