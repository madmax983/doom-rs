...
## 🔍 Gap Analysis
- **Current State:** The Options menu has a "Controls" placeholder item. Key mappings are likely statically defined. Gamepad support is being implemented but lacks dynamic rebinding.
- **Standard Libs / Market:** Almost all PC games provide key rebinding. This involves maintaining a dynamic mapping instead of matching hardcoded events.

## ✅ Acceptance Criteria
- Must implement a new customizable controls menu page accessible from the Options menu.
...
- Must serialize the updated keymap to a persistent config file.
