...
**[Tick Methods Refactor]**
**Learning:** Functions like `tick_floors` and `tick_ceilings` containing deep match and logic inside `retain_mut` closures are hard to read and test.
**Action:** Extract the inner logic of `retain_mut` into named helper methods.
