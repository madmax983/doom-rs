...
**Extracting Skullfly logic**
**Learning:** Embedded state-reset logic within large movement functions bloats the primary path. Extracting such conditional logic into helper functions cleans up the main function's readability.
**Action:** Look out for complex conditional logic blocks that can be extracted to well-named helper functions to improve clarity.
