...
**[Decouple doom-demo from doom-game]**
**Tangle:** doom-demo had an unnecessary dependency on doom-game just to export data types and constants.
**Blueprint:** Removed the doom-game dependency from doom-demo/Cargo.toml, breaking the dependency arrow and reducing coupling.
