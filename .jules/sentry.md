...
## 2026-07-22 - thing_flags evaluation test gap in UDMF parser
**Learning:** Table-driven tests are excellent for testing dense boolean logic like that found in parsing UDMF thing flags.
**Action:** Use table-driven tests when encountering configuration flags parsing which can fall back to various defaults when fields are missing.
