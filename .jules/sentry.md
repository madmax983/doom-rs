...
## 2024-05-18 - Missing Test Coverage in WadFile UDMF Endmap Parsing
**Learning:** Found a missing test case covering the `ENDMAP` lump behavior for UDMF files.
**Action:** Always verify all permutations in matched sequences like maps that demand explicit starting and ending marker lumps.
