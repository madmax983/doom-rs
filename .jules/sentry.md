...
## 2024-07-20 - Table-driven test in UDMF parsing
**Learning:** Testing logic mapping from stringly-typed configuration formats to fixed structs is tedious manually. Table-driven testing effectively and concisely captures combinations (like difficulty skills vs explicit flags).
**Action:** Use table-driven approaches for deserialization mapping of unstructured text properties.
