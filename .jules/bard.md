...
## 2026-08-09 - [Undocumented game state variables]
**Confusion:** The new director module lacked context about its interaction with the player state.
**Clarification:** Added module docs and a clear doc test to show how the AI director uses `PlayerState`.
