...
## 2024-08-13 - Panics in `doom-wad`
**Confusion:** `WadFile::parse` uses `expect` on a slice conversion, raising `clippy::missing_panics_doc`.
**Clarification:** Documented that the panic is unreachable due to prior bounds checks.
