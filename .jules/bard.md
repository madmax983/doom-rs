...
## 2024-05-18 - [Fixed missing module docs in game and renderer crates]
**Confusion:** Module `doom-game::director` and `doom-renderer::sprite_clip` were completely undocumented, making them hard to use or understand for other developers.
**Clarification:** Added module-level `//!` docs and doctest examples to both.
