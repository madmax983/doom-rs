...
## 2024-05-18 - [Added doctests for WeaponType, AmmoType, and TicCmd]
**Confusion:** The `WeaponType`, `AmmoType`, `WEAPON_AMMO`, and `bt` items in `doom-types` lacked executable examples.
**Clarification:** Added executable `## Examples` doc-tests for these public types to ensure documentation stays up-to-date and serves as functional examples.
