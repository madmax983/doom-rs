...
## 2024-05-18 - [Added missing doc tests for SnapshotRing]
**Confusion:** The `SnapshotRing` and its methods in `doom-net` lacked executable examples showing how to interact with the struct, especially how saving overwrites and retrieving functions work.
**Clarification:** Added executable `## Examples` doc-tests for `SnapshotRing` and its core methods.
