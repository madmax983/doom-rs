...
## 2024-06-02 - [Documented sprite_clip module]
**Confusion:** The `sprite_clip` module in `doom-renderer` was missing module-level documentation and executable examples, resulting in cargo doc errors and making its purpose unclear.
**Clarification:** Added module-level documentation (`//!`) and doc tests for `SpriteClipHistory` methods (`new`, `push`, `last`, `iter`).
