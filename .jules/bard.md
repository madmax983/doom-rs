...
## 2024-08-15 - Missing panics documentation for unreachable code
**Confusion:** Clippy complains about missing panics documentation for technically unreachable panics (due to expect).
**Clarification:** Rather than mechanically adding empty noise, we should explain why the panic is unreachable and provide executable doctests to verify.
